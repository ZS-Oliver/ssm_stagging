package cn.idea.modules.base.service;


import cn.idea.modules.base.constant.UserConst;
import cn.idea.modules.base.dao.BaseMapper;
import cn.idea.modules.base.exception.JudgeException;
...
import cn.idea.modules.base.vo.ConflictingQVo;
import cn.idea.modules.base.vo.PageVo;
...
public abstract class BaseService<V extends BaseVo, Q extends BaseQVo> {
     ...
     * @param v 实体，没有id属性
     */
    abstract protected void preSave(V v) throws JudgeException;
     ...
     */
    protected void postUpdate(V v) throws ServiceException {
    }

    @Transactional
    public BaseVo delete(int id) throws ServiceException {
        V v = baseMapper.find(id);
        if (v == null || v.getValid() == 0) {
