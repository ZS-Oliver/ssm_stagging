...
<div id="particles-js">
    <div class="login" style="display: block;">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="../admin/login/images/username.png"></div>
        ...
        <div class="login-center clearfix">
            ...
            <div class="login-center-input">
                ...
                <img id="cpacha-img" title="点击切换验证码" style="cursor:pointer;" src="cpacha?vl=4&w=150&h=40&type=loginCpacha" width="110px" height="30px" onclick="changeCpacha()">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function changeCpacha(){
        $("#cpacha-img").attr("src",'cpacha?vl=4&w=150&h=40&type=loginCpacha&t=' + new Date().getTime());
    }
